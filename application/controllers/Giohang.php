...
class Giohang extends CI_Controller {
    ...
    public function index(){
        $this->data['title']='Duc Hoang - Giỏ hàng của bạn';
    ...
    public function info_order(){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $this->data['title']='Duc Hoang - Thông tin đơn hàng';
    ...
    public function thankyou(){
        if($this->session->userdata('info-customer')||$this->session->userdata('sessionKhachHang')){
            ...
            $config['smtp_user']    = 'thantungshop@gmail.com';
            ...
            $this->email->from('thantungshop@gmail.com', 'Duc Hoang');
            $list = array($val['email']);
            $this->email->to($list);
            $this->email->subject('Hệ thống Duc Hoang');
        ...
        $this->data['title']='Duc Hoang.vn - Kết quả đơn hàng';
