    ...
    <div class="container">
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="col-xs-12 col-sm-6">
                <a href="trang-chu">
                    <img src="public/images/logoo.png" style="width: 80%;" class="img-fix f-logo" alt="smart-construction">
                </a>
                <div class="about-store">
                 Đức Hoàng shop. Chất lượng - giá cả hợp lý
             </div>
         </div>
         <div class="col-xs-12 col-sm-6">
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    <li class="clearfix">
                        ...
                        <span>1156 hoa hiep phuong 4 Tan Binh </span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-phone"></i>
                        <span>0967524243 - 089645343</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-envelope"></i>
                        <span><a href="mailto:ngoduchoanghihi@gmail.com">ngoduchoang@gmail.com</a></span>
                    </li>
                </ul>
            </div>
        </div>
